...
extern "C" JNIEXPORT void Java_cppbind_exceptions_StdException_jFinalize(JNIEnv*, jobject, jobjectid id){
    using namespace std;
...
extern "C" JNIEXPORT jlong Java_cppbind_exceptions_StdException_jGetcxxid(JNIEnv*, jobject, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jstring Java_cppbind_exceptions_StdException_jWhat([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace std;
...
extern "C" JNIEXPORT jstring Java_cppbind_exceptions_Std_1exc_1classesKt_jGettypebyid(JNIEnv* env, jclass, jobjectid id) {
    validateID(id);
